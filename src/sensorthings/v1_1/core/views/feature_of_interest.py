...
from sensorthings.v1_1.core.schemas import (CollectionQuery, EntityQuery, FeatureOfInterestCollectionResponse,
                                            FeatureOfInterestResponse, FeatureOfInterestPostBody,
...
@router.get(
    ...
    auth=app_settings.AUTH_HANDLERS.get("get_feature_of_interest_collection", app_settings.DEFAULT_AUTH_HANDLER),
    response={
...
@router.post(
    iot.FEATURES_OF_INTEREST,
    auth=app_settings.AUTH_HANDLERS.get("create_feature_of_interest", app_settings.DEFAULT_AUTH_HANDLER),
    response={
        201: None,
...
def create_feature_of_interest(
    ...
    entity: FeatureOfInterestPostBody
):
    """"""
...
@router.get(
    ...
    auth=app_settings.AUTH_HANDLERS.get("get_feature_of_interest", app_settings.DEFAULT_AUTH_HANDLER),
    response={
        200: FeatureOfInterestResponse,
...
@router.patch(
    f"{iot.FEATURES_OF_INTEREST}({app_settings.ID_DELIMITER}{{entity_id}}{app_settings.ID_DELIMITER})",
    auth=app_settings.AUTH_HANDLERS.get("update_feature_of_interest", app_settings.DEFAULT_AUTH_HANDLER),
    response={
        204: None,
...
@router.delete(
    f"{iot.FEATURES_OF_INTEREST}({app_settings.ID_DELIMITER}{{entity_id}}{app_settings.ID_DELIMITER})",
    auth=app_settings.AUTH_HANDLERS.get("delete_feature_of_interest", app_settings.DEFAULT_AUTH_HANDLER),
    response={
        204: None,
