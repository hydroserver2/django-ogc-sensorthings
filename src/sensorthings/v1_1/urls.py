...
from sensorthings.v1_1.views import (
...
if apps.is_installed("sensorthings.v1_1.extensions.multidatastream"):
    from sensorthings.v1_1.extensions.multidatastream.views import (
        multi_datastream_router_definition
    )
    from sensorthings.v1_1.extensions.multidatastream.schemas import (
