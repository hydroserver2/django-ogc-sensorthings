...
from sensorthings.v1_1.dto import EntityResultSetDTO, OrderByField, ThingDTO, LocationDTO
...
class BaseBackendAdapter(ABC):
    ...
    def resolve_operation(
        ...
        entity_name = str(entity_type).lower()
        operation_name = f"{method}_{entity_name}"
